...
--
-- Host: localhost
-- Generation Time: Mar 20, 2016 at 07:58 PM
...
CREATE TABLE tbl_oslink (
  oslink_id smallint(4) unsigned NOT NULL,
...
--
-- Indexes for table tbl_oslink
--
ALTER TABLE tbl_oslink
  ADD PRIMARY KEY (oslink_id);
...
--
-- AUTO_INCREMENT for table tbl_oslink
--
ALTER TABLE tbl_oslink
  MODIFY oslink_id smallint(4) unsigned NOT NULL AUTO_INCREMENT;
--
